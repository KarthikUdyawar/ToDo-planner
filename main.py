...
class App:
    def __init__(self) -> None:
        ...
        #! Enter todo list
        self.lbl_enter = Label(
            self.root,
            text="Enter what do you plan to do:",
            font=("Times", "14", "bold"),
        )
        ...
        self.button_push_doing = Button(
            ...
            font=("Times", "14", "italic bold"),
            cursor="hand2",
            command=self.push_doing_command,
        )
        self.button_push_doing.place(x=10, y=720)

        #! Push to done button
        self.button_push_done = Button(
            self.root,
            text="Push to done",
            width=43,
            activebackground="white",
            ...
            font=("Times", "14", "italic bold"),
            cursor="hand2",
            command=self.push_done_command,
        )
        ...
        self.lblInstruction = Label(
            self.root,
            text="F11 - Toggle Fullscreen , Escape - Quit",
            bg="darkblue",
            fg="white",
    ...
    def update_selected(self) -> None:
        with contextlib.suppress(NameError):
            database.update(
                self.getPrimaryKey(self.selected_string), self.enter_text.get()
            )
        self.refresh_text()
